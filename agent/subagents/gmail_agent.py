...
read_inbox_tool = Tool.from_function(read_inbox)
search_emails_tool = Tool.from_function(search_emails)
read_email_tool = Tool.from_function(read_email)
...
gmail_agent = Agent(
    ...
    tools=[read_inbox_tool, search_emails_tool, read_email_tool]
)
